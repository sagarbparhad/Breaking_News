...
class _TechnologyScreenState extends State<TechnologyScreen> {
  List<NewsTechnology> technologies = [];

  @override
  void initState() {
    super.initState();
    fetchtechnologiesNews();
  }

  Future<void> fetchtechnologiesNews() async {
    final url = Uri.parse(
        'https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=47d51d6d235e44099f1b6abebab2322b');
    final response = await http.get(url);

    if (response.statusCode == 200) {
      final data = jsonDecode(response.body);
      final List<NewsTechnology> fetchedtechnologies =
      (data['articles'] as List)
          .map((article) => NewsTechnology.fromJson(article))
          .toList();
                ...
                MaterialPageRoute(
                  builder: (context) => NewsDetailScreen(
                    article: NewsArticle(   // ✅ Convert to NewsArticle
                      ...
                      url: technology.url,
                      urlToImage: technology.urlToImage,
            ...
            child: Container(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      technology.urlToImage != null
                          ? ClipRRect(
                        borderRadius: BorderRadius.circular(12),
                        child: Image.network(
                          technology.urlToImage!,
                          width: 90,
                          height: 90,
                          fit: BoxFit.cover,
                        ),
...
class NewsTechnology {
  ...
  factory NewsTechnology.fromJson(Map<String, dynamic> json) {
